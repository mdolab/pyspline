...
f2py  --fcompiler=intele --f90flags=-r8 -c -m pyspline src/pyspline.pyf src/libspline.a -llapack -lg2c
...
# f2py  --fcompiler=intele --f90flags=-r8 -I./src_cs -c -m pyspline_cs src_cs/pyspline_cs.pyf src_cs/libspline_cs.a 
