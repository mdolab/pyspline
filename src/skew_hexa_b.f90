...
!   gradient, with respect to input variables: points skew
!   of linear combination of output variables: skew
SUBROUTINE SKEW_HEXA_B(points, pointsb, skew, skewb)
  IMPLICIT NONE
  DOUBLE PRECISION :: points(3, 8), skew
  DOUBLE PRECISION :: pointsb(3, 8), skewb
