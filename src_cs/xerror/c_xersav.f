...
C           PRINT BODY OF TABLE
            DO 20 I=1,10
               IF (KOUNT(I).ceq.0) GO TO 30
               WRITE (IUNIT,15) MESTAB(I),NERTAB(I),LEVTAB(I),KOUNT(I)
   15          FORMAT (1X,A20,3I10)
   20       CONTINUE
   30       CONTINUE
C           PRINT NUMBER OF OTHER ERRORS
            IF (KOUNTX.cne.0) WRITE (IUNIT,40) KOUNTX
...
C     OR ELSE DETERMINE THAT THE ERROR TABLE IS FULL.
      ...
      DO 90 I=1,10
         II = I
         IF (KOUNT(I).ceq.0) GO TO 110
         IF (MES.cne.MESTAB(I)) GO TO 90
         IF (NERR.cne.NERTAB(I)) GO TO 90
         IF (LEVEL.cne.LEVTAB(I)) GO TO 90
         GO TO 100
   90 CONTINUE
