      COMPLEX*16 FUNCTION CB3VAL(XVAL,YVAL,ZVAL,IDX,IDY,IDZ,TX,TY,TZ,
...
C
         ...
         DO 50 K=1,KZ
            ...
            DO 50 J=1,KY
               I = I + 1
               KCOLY = KCOLY + 1
               WORK(I) = CBVALU(TX,BCOEF(1,KCOLY,KCOLZ),NX,KX,IDX,XVAL,
     *                           INBVX,WORK(IW))
   50    CONTINUE
         INBV1 = 1
         IZM1 = IZ - 1
         ...
         DO 60 K=1,KZ
            I = (K-1)*KY + 1
            J = IZM1 + K
            WORK(J) = CBVALU(TY(KCOLY),WORK(I),KY,KY,IDY,YVAL,
     *                           INBV1,WORK(IW))
  60     CONTINUE
         INBV2 = 1
         KCOLZ = LEFTZ - KZ + 1
         CB3VAL = CBVALU(TZ(KCOLZ),WORK(IZ),KZ,KZ,IDZ,ZVAL,
     *                           INBV2,WORK(IW))
  100 CONTINUE
      RETURN
      END
